...
{
    public class ProducerConsumerQueueWaitHandle : IDisposable
    {
        ...
        public ProducerConsumerQueueWaitHandle() 
        {
        ...
        {
            using(ProducerConsumerQueueWaitHandle q = new ProducerConsumerQueueWaitHandle()) 
            {
